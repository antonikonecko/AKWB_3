...
struct Graf {
	...
	int stopien(int index) {     //metoda zwracajaca stopien wierzcholka o podanym indeksie
		int deg = 0;
	...
	std::vector<int> sasiedzi(int index) {     //metoda zwraca wektor indeksow wierzcholkow ktore sa polaczone krawedzia z podanym wierzcholkiem
		std::vector<int> n;
		for (int i = 0; i < lista_krawedzi.size(); i++) {
